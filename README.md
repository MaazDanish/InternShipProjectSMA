...
![react](./output/Screenshot%20(6).png)

Backend:
![backendoutput]

![springboot](./output/Screenshot%20(1).png)


Database:
![MySql Database]

![mysql](./output/Screenshot%20(9).png)

POSTMAN API:

![GET API](./output/Screenshot%20(3).png)

![POST API](./output/Screenshot%20(4).png)


### And coding style tests
The final output is shown below,

![Add Student](./output/Screenshot%20(7).png)

![Get Student](./output/Screenshot%20(8).png)
